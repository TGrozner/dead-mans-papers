...
1. Zinédine reprend conscience près du gobelet et du téléphone fissuré.
...
Le choix d'identité arrive devant les papiers du mort. Le joueur lit `Zinédine Saïdi`, puis choisit comment porter ce nom:
...
Objet central v0: une page arrachée du carnet d'Ahmed indique `P2 caméra morte / badge chantier / Hami ?`. Au verso: `Si Le Gobelet oublie, Amar sait. Sofiane a senti.`
